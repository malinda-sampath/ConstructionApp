namespace ConstructionApp.Views.Popups
{
    partial class Lorry
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2 = new Label();
            label1 = new Label();
            lorryLicense = new Label();
            label4 = new Label();
            lorryInsurance = new Label();
            label6 = new Label();
            label7 = new Label();
            label8 = new Label();
            label9 = new Label();
            lorryNewLicense = new DateTimePicker();
            lorryNewInsurance = new DateTimePicker();
            lorryUpdateBtn = new Button();
            ...
            lorryLicense.Text = "License Renewal Date";
            // 
            // label4
            // 
            ...
            lorryInsurance.Text = "Insurance Renewal Date";
            // 
            // label6
            // 
        ...
        private Label lorryLicense;
        private Label label4;
        private Label lorryInsurance;
        private Label label6;
        private Label label7;
        private Label label8;
        private Label label9;
        private DateTimePicker lorryNewLicense;
        private DateTimePicker lorryNewInsurance;
        private Button lorryUpdateBtn;
    }
}